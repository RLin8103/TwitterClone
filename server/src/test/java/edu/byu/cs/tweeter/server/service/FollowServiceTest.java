...
public class FollowServiceTest {
    ...
    public void setup() {
        ...
        Mockito.when(mockDynamoDBFollowDAO.getFollowees(request.getFollowerAlias(), request.getLimit(), request.getLastFolloweeAlias()))
        ...
        Mockito.when(followServiceSpy.getFollowingDAO()).thenReturn(mockDynamoDBFollowDAO);
    }
